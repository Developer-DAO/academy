...
- Some Goerli-ETH. You can ask for some in a faucet, it's free, although some
  ...
  [#2](https://faucets.chain.link/goerli), [#3](https://faucet.paradigm.xyz/), [#4](https://faucet.chainstack.com/goerli-faucet)
- An API Key from an Ethereum RPC Node Provider
  ([Alchemy](https://www.alchemy.com/), [Infura](https://infura.io/),
  [Ankr](https://rpc.ankr.com/eth_goerli)), [Chainstack](https://chainstack.com/))
