...
const GettingStarted: NextPage<LessonProps> = ({ lessons }) => {
        ...
        >
          <Stack spacing={5} direction="column">
            ...
            <Text apply="mdx.p" as="p" fontSize="xl" textAlign="center">
              ...
              with knowledge and tools that can be applied to real-world
              projects while promoting a healthy learning environment.
            </Text>
            <Divider />
            <Heading
              apply="mdx.h3"
