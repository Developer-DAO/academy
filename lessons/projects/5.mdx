...
If a different package manager has been used for previous lessons, pass in the appropriate 
flag while running your command as follows:
...
With this setup we can run the `npm run dev` command in our console and click 
