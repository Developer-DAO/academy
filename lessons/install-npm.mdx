...
** 2) We need to install curl into our WSL-2 instance, so type into the command line, <br>
...
** 3) Next, we want to install Node Version Manager (nvm). NVM is a super helpful tool because <br>
...
copy and paste the following command:<br>
         curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.1/install.sh | bash <br>                                                                                curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.1/install.sh | bash and hit Enter. Let’s verify that it was installed correctly by typing command -v nvm. This should return nvm if it was installed correctly. If you get an error or no output, close the Ubuntu terminal down and restart it. It should now return nvm. 
and hit Enter. Let’s verify that it was installed correctly by typing command -v nvm. This <br>
should return nvm if it was installed correctly. If you get an error or no output, close <br>
the Ubuntu terminal down and restart it. It should now return nvm. **
