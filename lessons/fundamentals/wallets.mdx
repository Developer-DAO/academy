...
You will have a separate mnemonic seed phrase, plus public and private keys for each one, *and* you will need to create a password, all of which you need to store safely somewhere. You can generate any number of key pairs from the seed phrase, which means that you can create as many accounts as you want inside a particulat wallet. As a developer, that’s handy when you need to send test transactions to mock actors when you are testing your apps. I also have a few accounts in my dev_workshops wallet.
