...
Since its launch in December of 2017, [**OpenSea.io**](https://opensea.io/) has grown into the largest digital marketplace in the digital world. As of June 2022, OpenSea has 200+ employees, 600K users, two million collections, over 80 million NFTs, and over $20 billion in annual trading volume([https://history-computer.com/opensea-history/](https://history-computer.com/opensea-history/)). 
...
- upoad your image
- name and give the NFT a description
- add a URL link to where the image is located
- add properties to the new NFT 
- choose the supply and the blockchain to which to deploy the NFT to
- then click `Create`. 
