...
Since its launch in December of 2017, [**OpenSea.io**](https://opensea.io/) has grown into the largest digital marketplace in the world. As of June 2022, OpenSea has 200+ employees, 600K users, two million collections, over 80 million NFTs, and over $20 billion in trading volume([https://history-computer.com/opensea-history/](https://history-computer.com/opensea-history/)). 

On OpenSea, you can currently create your own NFTs on the Ethereum, Polygon and Solana mainnet blockchains as well as the Goerli testnet. The simple process of uploading your image, naming and giving the NFT a description, adding a URL link to where the image is located, creating or adding it to a collection, add properties to the new NFT, generate statistics for the listing, choose the supply and the blockchain to deploy the NFT to, then click `Create`. 
