...
Next create a `test` folder in the root of your site, and add a new file called
`tier-nft.test.js` with these lines:
...
They also lead us to talk about general testing concepts.
