...
Next create a `test` folder in the root of your project, and add a new file called
...
With all the helpfulness of tests, why didn't we start with them before we
...
- you would have ended up writing better code because you discover quickly when
  code is impossible to test. You'll end up with the added benefit of breaking a big
