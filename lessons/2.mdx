...
<ContentSideDrawer title="What on Earth is Hardhat?">
    ...
    Hardhat is simply a set of tools that includes a local mini blockchain that can run on your machine. After you enter your `npx hardhat` command, what information can you see? What are those ten lines and  what is 
...
![deploy.output.png](/assets/lessons/2/img_16.pngg)
