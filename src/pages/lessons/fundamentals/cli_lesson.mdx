...
## CLI for everyone, and at its core . . . Linux!
...
### Where do I want to go? Absolute and relative paths
...
### Tidying up - leaving a clean codebase
...
`Ctrl+Alt+Tab`, you can close it with `Ctrl+D`. 
