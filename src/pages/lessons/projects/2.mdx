...
<NextSeo
  title="Lesson 2: Build a Basic NFT"
  description="Write and deploy a Smart Contract for a Basic NFT. Builds on knowledge from Lesson 1."
/>
...
<br />
<QuizStatusChecker quiz="lesson-2-quiz" />
<br />
