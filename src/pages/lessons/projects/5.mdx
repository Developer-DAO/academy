...
{/* see below // import { useEffect, useState } from "react"; MARKKOS89 NOTE: I WOULD REMOVE THIS IMPORT AND CONSIDER "USING/MOVING IT" TO INDEX.JS IMPROTS EXAPLANATION - go to line :238 */}
```jsx
import "@/styles/globals.css";
