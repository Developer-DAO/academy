...
import { useEffect, useState } from "react"; // MARKKOS89 NOTE: I WOULD REMOVE THIS IMPORT AND CONSIDER "USING/MOVING IT" TO INDEX.JS IMPROTS EXAPLANATION - go to line :238
...
const { connectors } = getDefaultWallets({
  appName: "TierNFTs Frontend Integration",
